  ...
  return (
    <section className="section-alt how-it-works">
      <div className="container">
        ...
        <div className={`how-steps ${inView ? 'in-view' : ''}`} id="howSteps" ref={stepsRef}>
          <div className="how-steps-line"><span></span></div>

          <div className="how-step" style={{'--d': '0s'} as any}>
          ...
          <div className="how-step" style={{'--d': '0.15s'} as any}>
            <div className="how-step-marker">
          ...
          <div className="how-step" style={{'--d': '0.3s'} as any}>
            <div className="how-step-marker">
