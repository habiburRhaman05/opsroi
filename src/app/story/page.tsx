        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 space-y-32 relative">
          ...
          <article className="grid md:grid-cols-2 gap-16 items-center md:flex-row-reverse relative z-10 group">
            ...
            <div className="md:order-1 grid grid-cols-2 gap-4">
               ...
               <a href="https://electricalroi.com" target="_blank" rel="noopener noreferrer" className="bg-white border border-line rounded-2xl p-6 text-center shadow-sm flex flex-col items-center justify-center aspect-square transition-transform hover:-translate-y-1 hover:shadow-md cursor-pointer">
                 <img src="/logos/ElectricalROI/ElectricalROI-1.png" alt="ElectricalROI" className="w-full max-w-[120px] h-auto object-contain" />
               </a>
