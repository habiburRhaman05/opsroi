      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="logo-badge" style={{width: '140px', height: 'auto', background: 'none', borderRadius: '0', padding: '0'}}>
              <Image src="/OpsROI-footer.webp" alt="OpsROI logo" width={140} height={40} style={{width: '100%', height: 'auto'}} />
            </div>
            <p>The CRM and client-ops platform designed specifically to turn your agency&apos;s client work into a clear, visible return.</p>
