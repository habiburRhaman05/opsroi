  ...
  return (
    <section id="services">
      <div className="container px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid-3 !grid !grid-cols-1 md:!grid-cols-2 lg:!grid-cols-3 !gap-6 lg:!gap-[26px]" id="platformGrid" data-stagger>

          {/* ── Original 6 cards ── */}
          <div className="platform-card !p-6 lg:!p-[34px_28px] h-full flex flex-col justify-start">
