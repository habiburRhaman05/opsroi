    ...
    <section id="pricing" className={`relative ${hideHeader ? 'pb-24 sm:pb-32 bg-transparent' : 'py-24 sm:py-32 bg-mist'}`}>
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 items-stretch">
          ...
          {/* Card 1: Growth */}
          <div className="bg-white rounded-[2rem] p-8 sm:p-10 lg:p-12 border border-line shadow-sm hover:shadow-xl transition-shadow duration-300 flex flex-col relative">
          ...
          {/* Card 2: Pro (Featured) */}
          <div className="bg-navy rounded-[2rem] p-8 sm:p-10 lg:p-12 shadow-2xl relative flex flex-col transform lg:-translate-y-4 border border-navy hover:border-[#22576b] transition-all duration-300">
