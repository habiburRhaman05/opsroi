      ...
      <main>
        ...
        <section id="contact" className="section-alt" style={{ paddingTop: '72px' }}>
          <div className="container">
            ...
            <div className="grid-3" style={{ '--reveal-delay': '0.18s', maxWidth: '900px', margin: '72px auto 0' } as React.CSSProperties}>
              <div className="step-row">
                <div className="step-num">1</div>
                <div>
                  <h4>You send the form</h4>
                  <p>Takes under a minute - tell us who you serve and what&apos;s slowing your ops down.</p>
                </div>
              </div>
              <div className="step-row">
                <div className="step-num">2</div>
                <div>
                  <h4>We book a call</h4>
                  <p>Within one business day, we&apos;ll reach out to schedule a short intro call.</p>
                </div>
              </div>
              <div className="step-row">
                <div className="step-num">3</div>
                <div>
                  <h4>We map your ops</h4>
                  <p>We walk through your sales-to-delivery flow and what OpsROI would set up for you.</p>
                </div>
              </div>
            </div>
          </div>
